...
{
    public class MenuPrincipal_D
    {
        private Cdconexion conexion = new Cdconexion();
        public DataTable listar(String NombreSP, List<MenuPrincipal_E> lst)
        {
        ...
        public void Insertar(String nombreSP, List<MenuPrincipal_E> lst)  // como parametro necesita el nombre del procedimiento almacenado y una lista generica que va a conetener parametros un array
        {
