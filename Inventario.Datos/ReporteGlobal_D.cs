...
{
    public class ReporteGlobal_D
    {

        private Cdconexion conexion = new Cdconexion();
        public DataTable listar(String NombreSP, List<ReporteGlobal_E> lst)
        {
        ...
        public void Insertar(String nombreSP, List<ReporteGlobal_E> lst)  // como parametro necesita el nombre del procedimiento almacenado y una lista generica que va a conetener parametros un array
        {
