...
{
    public class ReporteEgresos_D
    {

        private Cdconexion conexion = new Cdconexion();
        public DataTable listar(String NombreSP, List<ReporteEgresos_E> lst)
        {
        ...
        public void Insertar(String nombreSP, List<ReporteEgresos_E> lst)  // como parametro necesita el nombre del procedimiento almacenado y una lista generica que va a conetener parametros un array
        {
