...
{
    public class ReporteIngresos_E
    {
        ...
        public ReporteIngresos_E(String objNombre, Object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        public ReporteIngresos_E(String objNombre, SqlDbType objTipoDato, Int32 objTamaño)
        {
            Nombre = objNombre;
