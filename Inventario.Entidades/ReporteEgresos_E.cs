...
namespace Inventario.Entidades
{
    public class ReporteEgresos_E
    {
        ...
        public ReporteEgresos_E(String objNombre, Object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        public ReporteEgresos_E(String objNombre, SqlDbType objTipoDato, Int32 objTamaño)
        {
            Nombre = objNombre;
