...
namespace Inventario.Entidades
{
    public class MenuPrincipal_E
    {
        ...
        public MenuPrincipal_E(String objNombre, Object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        public MenuPrincipal_E(String objNombre, SqlDbType objTipoDato, Int32 objTamaño)
        {
            Nombre = objNombre;
