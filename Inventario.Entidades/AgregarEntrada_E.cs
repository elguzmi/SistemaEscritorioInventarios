...
namespace Inventario.Entidades
{
    public class AgregaEntrada_E
    {
        ...
        public AgregaEntrada_E(String objNombre, Object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        public AgregaEntrada_E(String objNombre, SqlDbType objTipoDato, Int32 objTamaño)
        {
            Nombre = objNombre;
