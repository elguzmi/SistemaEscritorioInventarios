...
namespace Inventario.Entidades
{
    public class ReporteGlobal_E
    {
        ...
        public ReporteGlobal_E(String objNombre, Object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        public ReporteGlobal_E(String objNombre, SqlDbType objTipoDato, Int32 objTamaño)
        {
            Nombre = objNombre;
