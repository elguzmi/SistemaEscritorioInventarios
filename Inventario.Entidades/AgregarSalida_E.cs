...
namespace Inventario.Entidades
{
    public class AgregarSalida_E
    {
        ...
        public AgregarSalida_E(String objNombre, Object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        public AgregarSalida_E(String objNombre, SqlDbType objTipoDato, Int32 objTamaño)
        {
            Nombre = objNombre;
